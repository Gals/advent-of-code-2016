...
def solve(blacklist, highest):
	...
	allowed = 0
	for i in xrange(0, len(expanded) - 1):
		allowed += expanded[i + 1][0] - expanded[i][1] - 1

	allowed += highest - expanded[-1][1]
	return allowed
...
def test():
	...
	assert solve([(5, 8), (0, 2), (4, 7)], highest=9) == 2
...
def main():
	...
	print solve(blacklist, 4294967295)
